...
describe('orderSearchComponent', function () {
  ...
  it('2 - should default input order number to empty', async(() => {
  ...
  it('3 - should store provided order number in component state', async(() => {
    fixture.detectChanges();
    fixture.whenStable().then(() => {
      input = fixture.debugElement.query(By.css('input'));
      let el = input.nativeElement;
  ...
  it('4 - should call resetOrderSearch method on cancel button event', async(() => {
  ...
  it('5 - should clear order number value on cancel button event', async(() => {
    fixture.detectChanges();
    fixture.whenStable().then(() => {
      input = fixture.debugElement.query(By.css('input'));
      let el = input.nativeElement;
  ...
  it('6 - should hide order search panel & reset search result data on cancel button event', async(() => {
  ...
  it('7 - should call findOrderByOrderNumber method on search button event', async(() => {
  ...
  it('8 - should set search result data, if order found for search', async(() => {
