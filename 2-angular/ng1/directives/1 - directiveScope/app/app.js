...
angular.module('app', [])
  ...
  /* Template access to Scope */
  // 1) directive using parent scope - Template can just reference as vm(template) or scope.vm(link fn) */
  ...
  // 2) directive using isolated scope - can pass in vm via scope (i've called it lscope)
