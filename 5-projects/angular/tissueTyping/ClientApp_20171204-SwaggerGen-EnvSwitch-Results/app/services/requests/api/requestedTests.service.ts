...
import { RequestedTestDto } from '../model/requestedTestDto';
...
@Injectable()
export class RequestedTestsService {
     ...
     * @param tests 
     */
    public apiRequestsByLabNumberRequestedTestsByTestsDelete(labNumber: string, tests: string, extraHttpRequestParams?: RequestOptionsArgs): Observable<{}> {
     ...
     */
    public apiRequestsByLabNumberRequestedTestsPost(labNumber: string, requestedTests?: Array<RequestedTestDto>, extraHttpRequestParams?: RequestOptionsArgs): Observable<Array<string>> {
     ...
     * @param tests 
     */
    public apiRequestsByLabNumberRequestedTestsByTestsDeleteWithHttpInfo(labNumber: string, tests: string, extraHttpRequestParams?: RequestOptionsArgs): Observable<Response> {
     ...
     * @param requestedTests 
     */
    public apiRequestsByLabNumberRequestedTestsPostWithHttpInfo(labNumber: string, requestedTests?: Array<RequestedTestDto>, extraHttpRequestParams?: RequestOptionsArgs): Observable<Response> {
        if (labNumber === null || labNumber === undefined) {
        ...
        let requestOptions: RequestOptionsArgs = new RequestOptions({
            ...
            headers: headers,
            body: requestedTests == null ? '' : JSON.stringify(requestedTests), // https://github.com/angular/angular/issues/10612
            withCredentials:this.configuration.withCredentials
        });
        // https://github.com/swagger-api/swagger-codegen/issues/4037
        if (extraHttpRequestParams) {
