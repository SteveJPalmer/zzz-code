...
export class AppComponent implements OnInit{
  ...
  constructor(private spinner: NgxSpinnerService, private router: Router, private authService: MsalService, private broadcastService: BroadcastService) {
    ...
    router.events.subscribe( evt => {
      ...
      if( evt instanceof NavigationEnd ){
        ...
        if ( evt.url != '/eticket' && evt.url != '/dropoff' && evt.url != '/e-checkin') {
          this.spinner.hide();
        }
      }
