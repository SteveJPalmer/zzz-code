!function(e) {
  var o = new ScrollMagic.Controller, t = ["#slide01", "#slide02", "#slide03"],
    r = ["#slide01 header", "#slide02 header", "#slide03 header"], n = ["#cb01", "#cb02", "#cb03"];
  if(!Modernizr.touch) {
    r.forEach(function(e, t) {
    ...
    }), t.forEach(function(t, r) {
      {
        ...
        new ScrollMagic.Scene({
          ...
          triggerHook: 1,
          duration: "100%"
        }).setTween(TweenMax.from(n, 1, {y: "-40%", autoAlpha: .3, ease: Power0.easeNone})).addTo(o)
      }
    });
    ...
    }).to(e("#intro .bcg"), 1.4, {y: "20%", ease: Power1.easeOut}, "-=0.2").to(e("#intro"), .7, {
      autoAlpha: .5,
      ease: Power1.easeNone
    }, "-=1.4");
    {
      new ScrollMagic.Scene({triggerElement: "#intro", triggerHook: 0, duration: "100%"}).setTween(a).addTo(o)
    }
